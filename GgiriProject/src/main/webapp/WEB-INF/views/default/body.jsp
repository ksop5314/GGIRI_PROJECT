...
<body>
    ...
    <div class="background">
		<div class="back" style="text-align:center; padding-top:8rem; padding-bottom:2rem; font-family: 'IBM Plex Sans KR', sans-serif;">
			...
			새로운 팀을 만들어<br>
			우리 '끼리' 계속 성장하는</p>
 			<img width="150px" height="45px" alt="" src="image/logo6.png">
			<br>
			<button class="signup" style="font-size:14px;width:130px;height:30px;"><a href="/signup-free">프리랜서 회원가입</a></button>
