...
<body>
	<c:import url="../default/header.jsp"/>
		...
		<table>
			...
			<tr>
				<th>근무 가능기간 : </th><td><input type="text" name="project_period" id="project_period" placeholder="200101" width="20" height="20" value="${info.project_period }"></td>
			</tr>
			<tr>
				<th>선호하는 근무장소 : </th><td><input type="text" name="place_of_work" id="place_of_work" placeholder="도시입력 예)서울:인천:대전" value="${info.place_of_work }"></td>
			</tr>
			<tr>
				<th>소개할 url : </th><td><input type="text" name="url_name" id="url_name" placeholder="소개할 url을 입력해주세요" value="${info.url_name }"></td>
			</tr>
			<tr>
