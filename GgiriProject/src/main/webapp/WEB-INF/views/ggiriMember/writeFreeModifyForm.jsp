...
<body>
	<c:import url="../default/header.jsp"/>
		...
		<table>
			...
			<tr>
				<th>근무 가능기간 : </th><td><input type="text" name="project_period" id="project_period" placeholder="200101" maxlength="15" size="20" value="${info.project_period }"></td>
			</tr>
			<tr>
			...
			<tr>
				<th>소개할 url : </th><td><input type="text" name="url_name" id="url_name" size="40" placeholder="소개할 url을 입력해주세요" maxlength="50" value="${info.url_name }"></td>
			</tr>
			<tr>
